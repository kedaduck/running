...
public class UrlContent {
    ...
    private static final String HOTEL_MODEL = "/restaurant/";
    public static final String FIND_ALL_HOTEL = BASE_MODEL + HOTEL_MODEL + "find_all.do";

    private static final String GOOD_MODEL = "/restaurant/";
    ...
    public static final String FIND_ALL_ATTRACTION = BASE_MODEL + ATTRACTION_MODEL + "find_all_attraction.do";
